...
function EditContact() {
    ...
    const handleSubmit = (e) => {
        ...
        if (form.email !== "")
            updatedContact.email = form.email;
        if (form.last_name !== "")
            updatedContact.last_name = form.last_name;
